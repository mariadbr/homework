...
public class HashSetTasks {
    public static Set<String> removeDuplicates(List<String> set) {    // вернуться к типам данных
    ...
    public static void main(String[] args) {
        ...
        for (String str : hashSet3) {
            if (str.equals(checkName)) {
                System.out.println(checkName + " is found in the set");
            }
        }
        }
    }
