...
public class IfElseTasks {
    public static void main(String[] args) {
        ...
        System.out.println(checkSignOfNumber(scanner));

        System.out.println(maxNumOfTwo(scanner));

        System.out.println(gradeDiscription(scanner));

        System.out.println(checkParity(scanner));

        System.out.println(checkSale(scanner));

        System.out.println(evaluationByScores(scanner));
    }

    //1. Определение знака числа
    public static String checkSignOfNumber(Scanner scanner) {
    ...
    public static int maxNumOfTwo(Scanner scanner) {
    ...
    public static String gradeDiscription(Scanner scanner) {
    ...
    public static String checkSale(Scanner scanner) {
    ...
    public static String evaluationByScores(Scanner scanner) {
